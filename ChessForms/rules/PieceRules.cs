...
{
    abstract class PieceRules
    {

        // Returns a list of all possible moves
        public abstract List<Tuple<uint, uint>> getPossibleMoves(Board board, Piece piece);

        // Returns a list of all covered squares
        public abstract List<Tuple<uint, uint>> getCover(Board board, Piece piece);

        //Checks if move is possible
        public bool movePossible(Board board, Piece piece, Tuple<uint,uint,uint,uint> move)
        {
            List<Tuple<uint, uint>> tmp;
            tmp = this.getPossibleMoves(board, piece);
        ...
        // Filter if check
        protected virtual void checkFilter(ref List<Tuple<uint, uint>> moves, Board board, Piece piece)
        {
